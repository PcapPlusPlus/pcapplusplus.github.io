...
## <img src="/img/os-logos/logo-windows.png" width="24" title="Windows"/> Windows
...
## <img src="/img/os-logos//logo-linux.png" width="24" title="Linux"/> Linux
...
## <img src="/img/os-logos//logo-apple.png" width="24" title="MacOS"/> MacOS
...
## <img src="/img/os-logos//logo-android.png" width="24" title="Android"/> Android

- All 4 major [Android ABIs](https://developer.android.com/ndk/guides/abis) are supported: `armeabi-v7a`, `arm64-v8a`, `x86`, `x86_64`
- API versions 21-30

## <img src="/img/os-logos//logo-freebsd.png" width="24" title="FreeBSD"/> FreeBSD

Versions 11.3 and above are supported

## Other platforms

Other platforms and toolchains may work as well, but the support is not guaranteed. If you'd like us to add additional platforms please [contact us *LINK*](/docs/community).
