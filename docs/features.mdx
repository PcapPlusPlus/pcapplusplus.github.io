...
- [eBPF XDP](https://en.wikipedia.org/wiki/Express_Data_Path) through [AF_XDP sockets](https://www.kernel.org/doc/html/next/networking/af_xdp.html) (on Linux)
