...
<ButtonLink text="Go to Doxygen API reference" link={"pathname:///api-docs/" + useActiveVersion().label.toLowerCase()}></ButtonLink>
<br/><br/>
...
<ThemedImageWithBaseUrl srcLight="/api-docs/libraries-light.svg" srcDark="/api-docs/libraries-dark.svg"/>
