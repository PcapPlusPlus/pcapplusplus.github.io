...
[<img src="/img/logo-dpdk.png" alt="drawing" width="400"/>](https://www.dpdk.org/)
...
Once the DPDK build is completed successfully, run PcapPlusPlus configuration script (`configure-linux.sh`) to build PcapPlusPlus with DPDK. Please refer to the [configuration instructions *LINK*](/docs/install/build-source/linux#configuration) to get more details.
