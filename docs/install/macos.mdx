...
2. PcapPlusPlus is available for both **Intel** and **Apple Silicon** processors. To build for a specific architecture you can use the `-DCMAKE_OSX_ARCHITECTURES` option, see more details below
