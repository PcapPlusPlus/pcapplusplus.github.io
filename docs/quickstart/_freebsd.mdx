...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [FreeBSD *LINK*](./install/build-source/freebsd#prerequisites).
...
If you have other versions of FreeBSD you'll need to [build PcapPlusPlus from source *LINK*](./install/build-source/freebsd). Make sure not to skip the [installation *LINK*](./install/build-source/freebsd#installation) part.
