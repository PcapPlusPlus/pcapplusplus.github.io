...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [MacOS *LINK*](/docs/install/build-source/macos#prerequisites).
...
Another option is to build PcapPlusPlus [from source *LINK*](/docs/install/build-source/macos). Make sure not to skip the [installation *LINK*](/docs/install/build-source/macos#installation) part.
