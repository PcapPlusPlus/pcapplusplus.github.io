...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [MinGW32 *LINK*](./install/build-source/mingw#prerequisites-for-building-with-mingw) or [MinGW-w64](./install/build-source/mingw#prerequisites-for-building-with-mingw-w64).
...
Otherwise you need to [build PcapPlusPlus from source](./install/build-source/mingw).
