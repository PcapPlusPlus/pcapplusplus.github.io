...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [Visual Studio *LINK*](./install/build-source/vs#prerequisites). Please notice that the currently supported versions of Visual Studio are 2015, 2017 and 2019.
