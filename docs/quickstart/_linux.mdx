...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [Linux *LINK*](./install/build-source/linux#prerequisites).
...
If you have other Linux distribution, another version of the distribution mentioned above or other GCC version you'll need to [build PcapPlusPlus from source *LINK*](./install/build-source/linux). Make sure not to skip the [installation *LINK*](./install/build-source/linux#installation) part.
