...
4. __OPTIONAL__ - install [Zstd](https://facebook.github.io/zstd/) if you wish to enable [PCAPNG streaming compression support](../features#readingwriting-pcapng-files-with-compression):
    ```shell
    brew install zstd
    ```
