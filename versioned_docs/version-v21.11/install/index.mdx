...
<p>
  <ButtonLink text={"Download master zip format"} link={getSourceCodeZipURL()} btnColor="#11b584"/>
  &nbsp;
  <ButtonLink text={"Download master tar.gz format"} link={getSourceCodeTarURL()} btnColor="#11b584"/>
</p>
