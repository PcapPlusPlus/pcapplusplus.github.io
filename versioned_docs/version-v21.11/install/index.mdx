...
import {ImageWithBaseUrl, ThemedImageWithBaseUrl} from '@site/src/components/ImageWithBaseUrl';
...
Available for: <ImageWithBaseUrl src="/img/os-logos/logo-linux.png" alt="drawing" width="24" title="Linux"/> <ThemedImageWithBaseUrl srcLight="/img/os-logos/logo-apple.png" srcDark="/img/os-logos/logo-apple-dark.png" width="24" title="MacOS"/>
