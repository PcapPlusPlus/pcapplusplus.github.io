...
3. __OPTIONAL__ - download and install [Zstd](https://github.com/facebook/zstd/releases/latest) if you wish to enable [PCAPNG streaming compression support](../features#readingwriting-pcapng-files-with-compression)
...
| __`--use-zstd`__              | use [Zstd for PCAPNG streaming compression](../features#readingwriting-pcapng-files-with-compression). This parameter is optional |
