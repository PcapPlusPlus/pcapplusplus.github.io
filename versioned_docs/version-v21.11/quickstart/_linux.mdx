...
Before installing PcapPlusPlus make sure you have the prerequisites installed for [Linux](./install/linux#prerequisites).
...
If you have other Linux distribution, another version of the distribution mentioned above or other GCC version you'll need to [build PcapPlusPlus from source](./install/linux). Make sure not to skip the [installation](./install/linux#installation) part.
