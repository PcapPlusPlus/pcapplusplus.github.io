...
PcapPlusPlus provides simple and easy-to-use wrappers for libpcap/WinPcap/Npcap APIs for capturing and sending packets over network interfaces. These wrappers pretty much sum up in the following classes:
